...
[CreateAssetMenu(menuName = "EnemyAbilities/LightAttack2")]
public class LightAttack2 : EnemyAbility
{
	public float range = 2f;

	private void OnEnable()
	{
		Boss.OnEnemyLightAttack2 += PerformAbility;
	}
