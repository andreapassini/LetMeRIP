...
[CreateAssetMenu(menuName = "EnemyAbilities/HeavyAttack")]
public class HeavyAttack : EnemyAbility
{
	public float range = 2f;

	private void OnEnable()
	{
		Boss.OnEnemyHeavyAttack += PerformAbility;
	}
