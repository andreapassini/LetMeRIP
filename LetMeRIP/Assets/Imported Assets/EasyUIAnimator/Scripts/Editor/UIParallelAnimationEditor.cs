...
using Imported_Assets.EasyUIAnimator.Scripts;
using Imported_Assets.EasyUIAnimator.Scripts.Utils;
using UnityEngine;
using UnityEditor;
        ...
        switch (type)
        {
            case AnimationType.MOVE:
                if (anim.useScreenValues)
                    ...
                    anim.start[0] = Vector3.Scale(anim.transform.position, UIAnimator.InvertedScreenDimension);
                break;
