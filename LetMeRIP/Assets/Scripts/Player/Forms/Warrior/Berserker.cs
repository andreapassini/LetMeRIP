...
public class Berserker : PlayerForm
{
    public override void Init(PlayerController characterController)
    {
        ...
        //abilities here
        BerserkerLightAttack la = gameObject.AddComponent<BerserkerLightAttack>();
        BerserkerHeavyAttack ha = gameObject.AddComponent<BerserkerHeavyAttack>();
        BerserkerAbility1 a1 = gameObject.AddComponent<BerserkerAbility1>();
        BerserkerAbility2 a2 = gameObject.AddComponent<BerserkerAbility2>();
